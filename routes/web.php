...
// LIST CAMPAIGN
Route::get('/campaigns', [CampaignListController::class, 'index'])
...
Route::middleware(['auth'])->group(function () {
    ...
    // Campaign USER
    Route::get('/user/campaigns', [UserCampaignController::class, 'index'])
        ->name('user.campaigns');

    Route::post('/user/campaigns/{id}/disburse', [UserCampaignController::class, 'requestDisbursement'])
        ->name('user.campaigns.disburse');

    Route::post('/user/campaigns/{id}/refund', [UserCampaignController::class, 'requestRefund'])
        ->name('user.campaigns.refund');
